  ...
  module.directive('sticky', ['$window', function ($window) {
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          // flag: can react to recalculating the initial CSS dimensions later as link executes prematurely
          var isStickyLayoutDeferred = (Boolean($attrs.isStickyLayoutDeferred));
          ...
          function memorizeDimensions() {
                ...
                onStickyContentLayoutHeightWatchUnbind = $scope.$watch(
                    ...
                    function(newValue, oldValue) {
                      if (newValue > 0) {
                        ...
                        // one time layout change. Afterwards stop reacting to subsequent changes.
                        // However, if content is rapidly changing its height, reconsider unbind
            ...
            // default to immediate assignment as normal
            else {
              calculateStickyContentInitialDimensions ();
            }
