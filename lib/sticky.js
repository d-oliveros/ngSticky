      ...
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          var initSticky = function () {
            // Maintain original element offset
            prevOffset = elementsOffsetFromTop($elem[0]);
          ...
          var onDigest = function () {
            ...
            if (anchor === 'top') {
              return elementsOffsetFromTop($elem[0]) - elementsOffsetFromTop(scrollbar);
            } else {
              return elementsOffsetFromTop($elem[0]) - scrollbarHeight() + $elem[0].offsetHeight;
            }
          };
          ...
          var onChange = function (newVal, oldVal) {
            if (( newVal !== oldVal || typeof stickyLine === 'undefined' ) && !isSticking) {
              ...
              stickyBottomLine = elementsDistanceFromScrollbarStart + elementsDistanceFromBottom - $elem[0].offsetHeight - marginBottom - offset;
